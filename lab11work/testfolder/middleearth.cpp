...
/**@brief this produces the earth itself as an object
 *@param xsize this is the length of the earth
 *@param ysize this is the width of the earth
 *@param num_cities this is the number of the cities on earth
 *@param seed this is a randomizer that distributes the placement of the cities
 */
...
/**@brief the destruction of earth
 */
MiddleEarth::~MiddleEarth () {
    delete[] distances;
}

/**@brief prints out information of the world
 * This information includes the number of cities, their names, and location in (x,y)
 */
...
/**@brief this prints a table of the distances between cities
 */
 ...
 *@return returns the resultant distance between the two cities
 */
float MiddleEarth::getDistance (string city1, string city2) {
    return distances[indices[city1]*cities.size()+indices[city2]];
}

/**@brief produces a list of cities to visit
 *@param length the number of cities to visit
 *@return produces a vector with cities to visit. First index is the starting and end location.
 */
