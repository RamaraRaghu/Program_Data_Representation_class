 ...
 * lab portions done by Rakshith Raghu, 10/22/2018
	...
	for(int k = 0; k < cols; k++){
	  for(int m = 3; m < 22; m++){
	    if(diction.inDictionary(getWordInGrid(j,k,i,m,rows,cols))){
		  ...
		  switch (i) {
		     case 0:
		       cout << "N (" << j << ", " <<  k << "):   " + found << endl;
		       break;
		     case 1:
		       cout << "NE (" << j << "," << k << "):  " + found << endl;
		       break;
		     case 2:
		       cout << "E (" << j << "," << k << "):   " + found << endl;
		       break;
		     case 3:
		       cout << "SE (" << j << "," << k << "):    " + found << endl;
		       break;
		     case 4:
		       cout << "S (" << j << "," << k << "):    " + found << endl;
		       break;
		     case 5:
		       cout << "SW (" << j << "," << k  << "):   " + found << endl;
		       break;
		     case 6:
		       cout << "W (" << j << "," << k << "):    " + found << endl;
		       break;
		     case 7:
		       cout << "NW (" << j << "," << k << "):    " + found << endl;
		       break;
		  }
					}}}}}
    t.stop();
